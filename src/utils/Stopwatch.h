 ...
 * @see [singleton
 * pattern](https://stackoverflow.com/questions/47558290/singleton-class-with-smart-pointers-and-destructor-being-called)
 */
...
private:
        ...
        std::chrono::time_point<std::chrono::system_clock>
            startTime{}; ///< The time at which the stopwatch object is started
        std::chrono::time_point<std::chrono::system_clock>
            stopTime{}; ///< The time at which the stopwatch object is stopped
